...
class GiantBombController extends BaseController {
	...
	public function getRecent($date)
	{
		...
		$call = file_get_contents('http://www.giantbomb.com/api/games/?api_key=' . $key . '&format=' . $format .'&limit=20&sort=original_release_date%3Adesc&filter=platforms:86,145,18,19,35,88,116,146,52,117,138,36,87,139,94,17,original_release_date:1700-01-01|' . $date);
